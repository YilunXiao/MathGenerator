...
public class Main {
	...
	public static void main(String[] args) {
		...
		*/
		...
		//Test equation parser and generator
		/*
		EquationParse parser = new EquationParse();
		StringGen generator = new StringGen();
		String equation; 
		for (int i=0; i<10; i++) {
			equation = generator.genEquation();
			System.out.println(equation + parser.solveEqu(equation));
		}
		*/
